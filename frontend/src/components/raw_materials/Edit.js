...
const Edit = ({ data, btnSubmit, handleSubmit, handleInputChange }) => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <Select name={'raw_material_categories_id'} endpoint={'/raw/material/categories'} data={data} color={'select-warning'} handleInputChange={handleInputChange} />
            <Select name={'units_id'} endpoint={'/units'} data={data} color={'select-warning'} handleInputChange={handleInputChange} />
